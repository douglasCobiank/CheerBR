...
/**
 * Componente do dashboard (Recharts-heavy). Carregado via Route.lazy a partir
 * de src/routes/dashboard.tsx, de forma que o bundle de Recharts (~120 KB
 * gzip) so e baixado quando o usuario visita /dashboard.
 */
